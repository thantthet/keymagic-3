...
echo "Starting KeyMagic 3 engine in debug mode..."
echo "This will register the engine as 'keymagic3-debug'"
echo ""

# Run in debug mode without --ibus flag
G_MESSAGES_DEBUG=all ./ibus-engine-keymagic3 --verbose &
ENGINE_PID=$!

echo "Engine started with PID: $ENGINE_PID"
echo ""
echo "You can now test the engine with:"
echo "  ibus engine keymagic3-debug"
echo ""
echo "To list available engines:"
echo "  ibus list-engine | grep keymagic3"
echo ""
